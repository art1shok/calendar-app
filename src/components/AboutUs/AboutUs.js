  ...
  <div className="about-us">
    <div className="about-us__container">
      <div className="about-us__text-container">
        <h3 className="about-us__title">Lorem ipsum creating timelines</h3>
        ...
        <p className="about-us__text">
          ...
          remembers
          coming across the lorem ipsum passage in a book of old metal type samples.
          So far he hasn&apos;t relocated where he once saw the
